...
namespace MariaTest {
	...
	public:
		TEST_METHOD(Interpreter_AddFloatingTask) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::ADD_FLOATING);
		...
		TEST_METHOD(Interpreter_AddDeadlineTask) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::ADD_DEADLINE);
		...
		TEST_METHOD(Interpreter_AddTimedTask) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::ADD_TIMED);
			Assert::AreEqual(expectedTitle, output->getTitle());
		...
		TEST_METHOD(Interpreter_EditTitle) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::EDIT_TITLE);
			Assert::AreEqual(expectedTitle, output->getTitle());
		...
		TEST_METHOD(Interpreter_EditStartTime) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::EDIT_START_TIME);
		...
		TEST_METHOD(Interpreter_EditEndTime) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::EDIT_END_TIME);
		...
		TEST_METHOD(Interpreter_EditDescription) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::EDIT_DESCRIPTION);
			Assert::AreEqual(expectedTitle, output->getTitle());
			Assert::AreEqual(expectedEditField, output->getEditField());
		...
		TEST_METHOD(Interpreter_ShowToday) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::SHOW_DATE);
			Assert::AreEqual(expectedTime->getYear(), output->getEndTime()->getYear());
			Assert::AreEqual(expectedTime->getMonth(), output->getEndTime()->getMonth());
			Assert::AreEqual(expectedTime->getDay(), output->getEndTime()->getDay());
		...
		TEST_METHOD(Interpreter_ShowDateRange) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::SHOW_DATE_RANGE);
			MariaTime* expectedStartTime = new MariaTime(MariaTime::getCurrentTime());
			Assert::AreEqual(expectedStartTime->getYear(), output->getStartTime()->getYear());
			Assert::AreEqual(expectedStartTime->getMonth(), output->getStartTime()->getMonth());
			Assert::AreEqual(expectedStartTime->getDay(), output->getStartTime()->getDay());
		...
		TEST_METHOD(Interpreter_SearchTask) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::SEARCH);
			Assert::AreEqual(expectedTitle, output->getTitle());
		...
		TEST_METHOD(Interpreter_DeleteTask) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::DELETE_TASK);
			Assert::AreEqual(expectedTitle, output->getTitle());
		...
		TEST_METHOD(Interpreter_DeleteAllTask) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::DELETE_ALL);
			Assert::AreEqual(expectedTitle, output->getTitle());
		...
		TEST_METHOD(Interpreter_MarkDone) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::MARK_DONE);
			Assert::AreEqual(expectedTitle, output->getTitle());
		...
		TEST_METHOD(Interpreter_MarkUndone) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::MARK_UNDONE);
			Assert::AreEqual(expectedTitle, output->getTitle());
		...
		TEST_METHOD(Interpreter_Undo) {
			...
			Assert::IsTrue(output->getCOMMAND_TYPE() == MariaInputObject::COMMAND_TYPE::UNDO);
